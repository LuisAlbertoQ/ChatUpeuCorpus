...
- **Total de interacciones evaluadas:** 266
...
| Métrica | Valor |
|---|---:|
| % respuestas exitosas (M02) | 57.9% |
| % fuera de dominio (M03) | 4.5% |
| % sin cobertura (M04) | 22.6% |
| % preguntas ambiguas (M05) | 5.6% |
| % errores (M06) | 9.4% |
| % con fuentes documentales | 57.1% |
| Tiempo promedio (segundos) | 15.03 |
